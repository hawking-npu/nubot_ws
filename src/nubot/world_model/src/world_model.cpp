...
nubot::World_Model::World_Model(int argc,char** argv,const char * name)
{
    ...
    front_vision_sub_   =  nh->subscribe("frontvision/FrontBallInfo",1,&nubot::World_Model::updateFrontVision, this);
    /** 订阅kinect节点topic，守门员移动机器人*/
    kinect_vision_sub_  =  nh->subscribe("stereovision/StereoBallInfo",1,&nubot::World_Model::updateKinectBall, this);
