...
DPoint ball_pos_;
    ...
    double a=now_ob.x_*now_ob.x_-(my_radius+obs_radius)*(my_radius+obs_radius);
    double b=-2*now_ob.x_*now_ob.y_;
    double c=now_ob.y_*now_ob.y_-(my_radius+obs_radius)*(my_radius+obs_radius);
    ...
    if(delta>=0)
    {
        ...
        //y=use_k*x
        double len=sqrt(now_ob.x_*now_ob.x_+now_ob.y_*now_ob.y_-(my_radius+obs_radius)*(my_radius+obs_radius));
