...
if("FALSE" STREQUAL "TRUE")
  set(gscam_SOURCE_PREFIX /home/lzz/nubot_ws/src/camera_driver/tiscamera/gscam)
  set(gscam_DEVEL_PREFIX /home/lzz/nubot_ws/devel)
  set(gscam_INSTALL_PREFIX "")
  set(gscam_PREFIX ${gscam_DEVEL_PREFIX})
else()
  set(gscam_SOURCE_PREFIX "")
  set(gscam_DEVEL_PREFIX "")
  set(gscam_INSTALL_PREFIX /home/lzz/nubot_ws/install)
...
if(NOT "include;/usr/include/gstreamer-0.10;/usr/include/glib-2.0;/usr/lib/x86_64-linux-gnu/glib-2.0/include;/usr/include/libxml2 " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gscam' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lzz/nubot_ws/install/${idir}'.  ${_report}")
    endif()
