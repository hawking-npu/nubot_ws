...
(cl:in-package nubot_hwcontroller-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <DebugInfo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DebugInfo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nubot_hwcontroller-msg:<DebugInfo> is deprecated: use nubot_hwcontroller-msg:DebugInfo instead.")))

(cl:ensure-generic-function 'd1-val :lambda-list '(m))
(cl:defmethod d1-val ((m <DebugInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nubot_hwcontroller-msg:d1-val is deprecated.  Use nubot_hwcontroller-msg:d1 instead.")
  (d1 m))

(cl:ensure-generic-function 'd2-val :lambda-list '(m))
(cl:defmethod d2-val ((m <DebugInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nubot_hwcontroller-msg:d2-val is deprecated.  Use nubot_hwcontroller-msg:d2 instead.")
  (d2 m))
