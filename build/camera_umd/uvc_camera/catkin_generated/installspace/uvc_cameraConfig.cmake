...
if("FALSE" STREQUAL "TRUE")
  set(uvc_camera_SOURCE_PREFIX /home/jensen/nubot_ws/src/camera_umd/uvc_camera)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'uvc_camera' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jensen/nubot_ws/install/${idir}'.  ${_report}")
    endif()
