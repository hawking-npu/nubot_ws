...
if("FALSE" STREQUAL "TRUE")
  set(nubot_common_SOURCE_PREFIX /home/jerry/nubot_ws/src/nubot/nubot_common)
  set(nubot_common_DEVEL_PREFIX /home/jerry/nubot_ws/src-build/devel)
...
if(NOT "include;/opt/ros/kinetic/include;/opt/ros/kinetic/share/xmlrpcpp/cmake/../../../include/xmlrpcpp;/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'nubot_common' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/usr/local/${idir}'.  ${_report}")
    endif()
