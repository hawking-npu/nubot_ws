...
if("FALSE" STREQUAL "TRUE")
  set(calibration_util_SOURCE_PREFIX /home/jerry/nubot_ws/src/calibration_util)
  set(calibration_util_DEVEL_PREFIX /home/jerry/nubot_ws/src-build/devel)
  ...
  set(calibration_util_INSTALL_PREFIX /usr/local)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'calibration_util' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/usr/local/${idir}'.  ${_report}")
    endif()
