...
get_filename_component(_filename "/home/jerry/nubot_ws/src/2D_Plot_Tool/plot_tool/srv/PlotPath.srv" NAME_WE)
add_custom_target(_plot_tool_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "plot_tool" "/home/jerry/nubot_ws/src/2D_Plot_Tool/plot_tool/srv/PlotPath.srv" "geometry_msgs/PoseStamped:std_msgs/Header:geometry_msgs/Quaternion:geometry_msgs/Point:geometry_msgs/Pose:nav_msgs/Path"
)

get_filename_component(_filename "/home/jerry/nubot_ws/src/2D_Plot_Tool/plot_tool/srv/PlotPose.srv" NAME_WE)
add_custom_target(_plot_tool_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "plot_tool" "/home/jerry/nubot_ws/src/2D_Plot_Tool/plot_tool/srv/PlotPose.srv" "geometry_msgs/Quaternion:geometry_msgs/Pose:geometry_msgs/Point"
)
